        ...
        try:
            if cross_compiling:
                ...
                if xcompile_dependency_dir:
                    ...
                    if xcompile_dependency_dir + '/usr/include' not in self.include_dirs:
                        self.include_dirs += [xcompile_dependency_dir + '/usr/include']
                    if xcompile_dependency_dir + '/lib' not in self.library_dirs:
                        self.library_dirs += [xcompile_dependency_dir + '/lib']
                    if xcompile_dependency_dir + '/usr/lib' not in self.library_dirs:
                        self.library_dirs += [xcompile_dependency_dir + '/usr/lib']
